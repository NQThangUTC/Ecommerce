...
namespace EcommerceMVC.Controllers
{
    public class HangHoasController : Controller
    {
        ...
        {
            var hshop2023Context = _context.HangHoas.Include(h => h.MaNccNavigation).Include(h => h.MaNccNavigation);
            return View(await hshop2023Context.ToListAsync());
        }

        //GET: HangHoas/Detail/id
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var hangHoa = await _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation).FirstOrDefaultAsync(m => m.MaHh == id);
            if (hangHoa == null)
            {
                return NotFound();
            }
